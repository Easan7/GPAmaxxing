...
def _generate_branch_response(state: GraphState, branch: str) -> str:
    ...
    short_prompt = (
        ...
        "If rag_resources is provided, incorporate them as action items within the main next-steps list with bold main actions: '- **Review <real source name>** — why and what to focus on'. "

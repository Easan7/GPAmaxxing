        ...
        <div className="h-full w-full flex">
            ...
            <div className="flex-1 flex flex-col min-w-0">
                ...
                <div className="h-14 px-6 flex items-center border-b border-gray-100 bg-white shrink-0">
                    ...
                    <div className="ml-auto flex items-center gap-2 text-xs font-semibold text-gray-600">
                        <input
                            id="plan-mode-toggle"
                            type="checkbox"
                            checked={planMode}
                        ...
                        />
                        <label htmlFor="plan-mode-toggle" className="cursor-pointer select-none">
                            Planning Mode
                        </label>
                    </div>
                </div>
    ...
    return (
        <div className="rounded-2xl border border-indigo-100 bg-indigo-50/60 px-4 py-4 shadow-sm">
            <div className="flex items-center justify-between gap-3 mb-2">
                ...
                <span className="text-[11px] font-semibold text-indigo-600">Better details = better plan</span>
            </div>

            <p className="text-sm text-indigo-900 mb-3">
                Include as many of these as possible when asking for a plan:
            </p>
            ...
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm text-gray-700">
                ...
                <li className="rounded-lg bg-white/70 border border-indigo-100 px-3 py-2">Availability pattern (weekday/weekend split)</li>
                <li className="rounded-lg bg-white/70 border border-indigo-100 px-3 py-2">Milestones (quiz or exam date)</li>
                <li className="rounded-lg bg-white/70 border border-indigo-100 px-3 py-2">Preference (timed drills, revision-heavy, etc.)</li>
            </ul>
        </div>
    );
}
